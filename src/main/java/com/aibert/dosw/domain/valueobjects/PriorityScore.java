 ...
 *
 * <p>The priority is calculated based on three weighted factors:</p>
 * <ol>
 *   <li><b>Deadline proximity</b> — how soon the task is due</li>
 *   <li><b>Academic weight</b> — percentage the subject represents in the semester load (RN-03)</li>
 *   <li><b>Estimated time</b> — corrected duration factor (AIB-22.4)</li>
 * </ol>
 *
 * <p><b>RN-02:</b> A task with a deadline within 24 hours is automatically escalated
 * to {@link TaskPriority#CRITICAL} regardless of other factors.</p>
 */
@Getter
public final class PriorityScore {
     ...
     *
     * <p>The three weights should sum to 1.0 so the final score stays in [0, 100].</p>
     *
     * <p><b>RN-02 (AIB-22):</b> If {@code hoursLeft ≤ 24}, the task is automatically
     * escalated to {@link TaskPriority#CRITICAL} with a score of 100.0.</p>
     *
    ...
    private static double calculateProximityScore(long hoursLeft) {
        if (hoursLeft <= 24)  return 100.0;
        if (hoursLeft <= 48)  return 80.0;
        if (hoursLeft <= 120) return 60.0;
        return 40.0;
    }
