...
public class PrioritizationController {
    ...
    /**
     * Exposes a REST endpoint that returns active tasks ordered descendingly by priority score.
     * 
     * @param studentId         The ID of the student requesting the prioritization
     * @param forceRecalculate  If true, forces the engine to recalculate priority scores
